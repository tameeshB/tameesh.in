...
<head>
  ...
  <link rel="stylesheet" href="indexbo.css">
...
.desc{
 	color: #FFFFFF;
 	font-size: 25px;
    text-shadow: rgba(0, 0, 0, 0.97) 0px 0px 18px;
}
#btn2{
...
<div id="card1wrap">
  ...
  <h3 class="desc">Computer Science, Programming and physics lover ♥ </h3><center>
 	<button id="btn2" class="buttonwa">Know more</button>
 	<!--<img src="dwn.png">-->
 	 </center> </div>
</div>
...
<div id="card2" class="cards row">
	...
	<div id="snippet_wrapper" class="halves uhalf" style="height:45%">
	  ...
	  <button id="bt1" class="buttonwa">Get There!</button><center>
...
<div id="card3" class="cards row">
	...
	<div id="work_title"><h1 style="font-size:50px;text-shadow:#FFFFFF 0 0 7px">Projects</h1></div>
	  		...
	  		<button class="buttonwa" id="bt3" onclick="call_slider('./about/index.php#thirdhead',1)">See them-></button>
</div>
